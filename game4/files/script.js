...
const gameInit = () => {
	...
	buttonYes.addEventListener('click', function () {
		if (check2){
			if (check) {
				if (document.getElementById("number1").innerText % document.getElementById("number2").innerText == 0) {
					generateQuestion();
...
function generateQuestion() {
	...
	if (difficulty == "easy"){
		b = getRandomIntInclusive(2,3);
		a = getRandomIntInclusive(b, 100);
	}
	if (difficulty == "normal"){
		b = getRandomIntInclusive(2, 6);
		a = getRandomIntInclusive(b, 500);
	}
	if (difficulty == "hard"){
		b = getRandomIntInclusive(2, 12);
		a = getRandomIntInclusive(b, 2000);
	}
	...
	document.getElementById("number1").innerText = a;
